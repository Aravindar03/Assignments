...
console.log(`Temperature of a city in degrees Celsius is: ${temperature}`);
...
let personFavcolor : string = "Blue";
console.log(`Person's occupation: ${personFavcolor}`);
...
console.log(`Person's eye color: ${personBirthplace}`);
